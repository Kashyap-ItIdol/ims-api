...
namespace IMS_Application.Services.Interfaces
{
    public interface ITicketService
    {
        ...
        Task<TicketCommentResponseDto> AddCommentAsync(int ticketId, string commentText, int currentUserId);
        Task<UpdateTicketStatusResponseDto> UpdateStatusAsync(int ticketId, string status, int currentUserId);
